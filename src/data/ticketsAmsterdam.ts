...
// Officiële dataset voor Amsterdam Whisky Festival (De Hallen Amsterdam)
...
export interface TicketItem {
  ...
  status?: 'sold-out' | 'limited' | 'popular' | 'selling-fast' | 'coming-soon';
  statusText?: string;
  extra?: string;
  description?: string;
...
export const TICKETS_AMSTERDAM: TicketItem[] = [
  // 1. Entrees (Zaterdag 16 januari 2027)
  {
    ...
    description: "Beleef het Amsterdam Whisky Festival in de prachtige locatie van De Hallen. Geniet 4 uur lang van honderden whisky's, distilleerders en de unieke sfeer.",
    ambassadorName: "Amsterdam Festival Team",
    ambassadorTitle: "Festival Host",
    ambassadorBio: "Ons team heet u van harte welkom in De Hallen Amsterdam.",
    tastingLineup: [
  ...
  },
  {
    ...
    isLowStock: false,
    extra: "Inclusief officieel Glencairn proefglas",
    description: "Sfeervolle avondsessie in De Hallen Amsterdam met intieme verlichting, live doedelzakmuziek en topselectie drams.",
    ambassadorName: "Amsterdam Festival Team",
    ambassadorTitle: "Festival Host",
    ambassadorBio: "Ons team heet u van harte welkom in De Hallen Amsterdam.",
    tastingLineup: [
  ...
  // 2. Festival Botteling
  {
    ...
    bookingType: "Vrij te boeken voor iedereen",
    location: "Festival Info Desk (Alleen afhalen op festival)",
    capacity: 40,
    sold: 0,
    isSoldOut: false,
    isLowStock: true,
  ...
  // 3. Masterclasses (8 tijdslots - De Hallen Amsterdam)
  {
    ...
    location: "Masterclass Zaal De Hallen",
    capacity: 30,
    sold: 0,
    isSoldOut: false,
    isLowStock: false,
    ...
    status: "coming-soon",
    statusText: "Binnenkort bekend",
    extra: "Programma en line-up worden binnenkort bekendgemaakt",
    description: "Intieme masterclass van 45 minuten onder leiding van een internationale whisky ambassador in De Hallen.",
  ...
  },
  {
    ...
    statusText: "Binnenkort bekend",
    extra: "Programma en line-up worden binnenkort bekendgemaakt",
    description: "Diepgaande proeverij met zeldzame expressies en deskundige toelichting in De Hallen.",
    ambassadorName: "Brand Ambassador",
    ambassadorTitle: "Distillery Specialist",
    tastingLineup: [
      "4 tot 5 exclusieve proefdrams",
  ...
  },
  {
    ...
    statusText: "Binnenkort bekend",
    extra: "Programma en line-up worden binnenkort bekendgemaakt",
    description: "Diepgaande avondproeverij met exclusieve vaten en distilleerderijverhalen in De Hallen.",
    ambassadorName: "Brand Ambassador",
    ambassadorTitle: "Distillery Specialist",
    tastingLineup: [
      "4 tot 5 exclusieve proefdrams",
  ...
  },
  {
    ...
    statusText: "Binnenkort bekend",
    extra: "Programma en line-up worden binnenkort bekendgemaakt",
    description: "De feestelijke afsluitende masterclass van het Amsterdam Whisky Festival in De Hallen.",
    ambassadorName: "Brand Ambassador",
    ambassadorTitle: "Distillery Specialist",
    tastingLineup: [
      "4 tot 5 exclusieve proefdrams",
